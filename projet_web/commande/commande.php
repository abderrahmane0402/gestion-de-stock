...
<body class="navbar-fixed sidebar-fixed" id="body">
                                ...
                                <div class="card-body">
                                    <form method="post" action="facture.php">
                                        <div class="form-group">
                                            <label for="num_cmd">Numero de Commande</label>
                                            <input type="number" class="form-control" id="num_cmd"
                                                placeholder="Enter la numero de commande" name="num_cmd" required />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker" data-live-search="true" name="client" required>
                                                <?php
                                                    $liste = client::afficheClient();
                                                    $i=1;
                                                    foreach($liste as $i=>$p){
                                                ?>
                                                <option value="<?= $p->id ?>"><?= $p->nom ?>-<?= "0".$p->tele ?>
                                                </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <table class="table table-bordered" id="table">
                                                            ...
                                                            <tbody>
                                                                <?php 
                                                                  require_once "../class/Produit.php";
                                                                  $liste = Produit::afficheProduitWithCat_n0();
                                                                  $i=1;
                                                                  foreach($liste as $i=>$p){
                                                                ?>
                                                                <tr>
    ...
    <script>
    document.querySelector(".page-title").innerHTML = "Commande";
